...
public class CustomerBackendConfiguration {
  ...
  @Bean
  public DomainEventDispatcher customerServiceDomainEventDispatcher(CustomerEventHandlers orderHistoryEventHandlers,
                                                                    MessageConsumer messageConsumer,
                                                                    DomainEventNameMapping domainEventNameMapping) {
    return new DomainEventDispatcher("customerServiceDomainEventDispatcher",
